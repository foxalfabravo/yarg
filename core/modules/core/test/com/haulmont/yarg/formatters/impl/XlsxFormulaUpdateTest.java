...
public class XlsxFormulaUpdateTest {
    ...
    public void testFormulaShifts() throws Exception {
        ...
        xlsxFormatter.updateFormula(1,cellWithFormula, Range.fromRange("Sheet", "A9:A9"), Range.fromRange("Sheet", "A90:A90"), null, 0);
        xlsxFormatter.updateFormula(1,cellWithFormula, Range.fromRange("Sheet", "B9:B9"), Range.fromRange("Sheet", "B90:B90"), null, 0);
        Assert.assertEquals("SUM(A90:A90)/B90", cellWithFormula.getF().getValue());

        cellWithFormula = cellWithFormula("SUM(A9:B9)");
        xlsxFormatter.updateFormula(1,cellWithFormula, Range.fromRange("Sheet", "A9:B9"), Range.fromRange("Sheet", "A90:B90"), null, 0);
